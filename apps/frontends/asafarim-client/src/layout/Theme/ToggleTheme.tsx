...
import { WeatherMoonFilled, WeatherSunnyFilled, Star24Regular } from '@fluentui/react-icons';
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full w-full overflow-hidden rounded-lg">
        ...
        >
          {isDark ? (
            <WeatherMoonFilled fontSize={size + 4} className="drop-shadow-lg" />
          ) : (
            <WeatherSunnyFilled fontSize={size + 4} className="drop-shadow-lg" />
          )}
        </div>
